...
<div class="team-social-links">
  ...
  <a href="https://orcid.org/0000-0000-0000-0000" class="social-icon orcid" aria-label="ORCID" target="_blank">
    <i class="fab fa-orcid"></i>
  </a>
  <a href="http://lattes.cnpq.br/seu-id-lattes" class="social-icon lattes" aria-label="Lattes" target="_blank">
    <i class="fas fa-graduation-cap"></i>
  </a>
  <a href="https://www.linkedin.com/in/rodrigo-ozon" class="social-icon linkedin" aria-label="LinkedIn" target="_blank">
    <i class="fab fa-linkedin-in"></i>
  </a>
  <a href="https://github.com/rodrigo-ozon" class="social-icon github" aria-label="GitHub" target="_blank">
